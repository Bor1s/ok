...
if [[ "$PLATFORM" == "darwin" ]]; then
  ...
  overwrite_file "$TEMP_DIR/$PLATFORM/terminal/zsh/.zshrc" "$ZSH_CONFIG_FILE"
  copy_if_not_exist "$TEMP_DIR/$PLATFORM/terminal/wezterm/.wezterm.lua" "$WEZTERM_CONFIG_FILE"
  copy_if_not_exist "$TEMP_DIR/$PLATFORM/terminal/wezterm" "$WEZTERM_CONFIG_DIR"
